...
if __name__ == '__main__':
    ...
    print ('e = {0}'.format(e))
    print ('d = {0}'.format(d))
    message = "encrypted_data hdkdkd hdhdjd jhd dhdhdhd dkhdhdhdhdkhd kdhdkhasksh dsshskhs khdkhshs kshdkshs khskhskhs hskhkhks hskhhksh skhshs khshksks skhskhshs skshkhskhskhskhs jks skslsslslslslslssss))"
    cipher = encrypt(message, n, e, 5)#len([message]))
    print(cipher)
    Amessage = decrypt(cipher, n, d, 5)#len([message]))
    print(Amessage)"""
